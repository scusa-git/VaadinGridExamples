...
public abstract class AbstractGridView extends VerticalLayout implements GridView {
        ...
        try {
            ...
            if (in != null) {
                ...
                try (BufferedReader reader = new BufferedReader(new InputStreamReader(in))) {
                    ...
                    while (line != null) {
                        if (line.contains("public Component getGrid() {")) {
                            inCodeBlock = true;
                        } else if (line.contains("return grid;")) {
                            inCodeBlock = false;
                        } else if (inCodeBlock) {
